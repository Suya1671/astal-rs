...
glib::wrapper! {
    #[doc(alias = "AstalBox")]
    pub struct Box(Object<ffi::AstalBox, ffi::AstalBoxClass>) @extends gtk::Box, gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Orientable;
...
pub trait BoxExt: IsA<Box> + sealed::Sealed + 'static {
    ...
    fn set_child(&self, value: Option<&impl IsA<gtk::Widget>>) {
        unsafe {
            ffi::astal_box_set_child(self.as_ref().to_glib_none().0, value.map(|p| p.as_ref()).to_glib_none().0);
        }
    }
    ...
    fn connect_child_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_child_trampoline<P: IsA<Box>, F: Fn(&P) + 'static>(this: *mut ffi::AstalBox, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Box::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
