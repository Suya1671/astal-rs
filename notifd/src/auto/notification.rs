...
impl NotificationBuilder {
    ...
    pub fn app_icon(self, app_icon: impl Into<glib::GString>) -> Self {
        Self {
            builder: self.builder.property("app-icon", app_icon.into()),
        }
    }

    pub fn summary(self, summary: impl Into<glib::GString>) -> Self {
        Self {
            builder: self.builder.property("summary", summary.into()),
        }
    }
    ...
    pub fn id(self, id: u32) -> Self {
        Self {
            builder: self.builder.property("id", id),
        }
    }

    pub fn expire_timeout(self, expire_timeout: i32) -> Self {
        Self {
            builder: self.builder.property("expire-timeout", expire_timeout),
        }
    }
...
pub trait NotificationExt: IsA<Notification> + sealed::Sealed + 'static {
    ...
    fn hint(&self, hint: &str) -> Option<glib::Variant> {
        unsafe {
            from_glib_full(ffi::astal_notifd_notification_get_hint(
    ...
    fn str_hint(&self, hint: &str) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::astal_notifd_notification_get_str_hint(
                self.as_ref().to_glib_none().0,
                hint.to_glib_none().0,
            ))
        }
    ...
    fn is_bool_hint(&self, hint: &str) -> bool {
        unsafe {
            from_glib(ffi::astal_notifd_notification_get_bool_hint(
                self.as_ref().to_glib_none().0,
                hint.to_glib_none().0,
            ))
        }
    ...
    fn int_hint(&self, hint: &str) -> i32 {
        unsafe {
            ffi::astal_notifd_notification_get_int_hint(
                self.as_ref().to_glib_none().0,
                hint.to_glib_none().0,
            )
        }
    ...
    fn byte_hint(&self, hint: &str) -> u8 {
        unsafe {
            ffi::astal_notifd_notification_get_byte_hint(
                self.as_ref().to_glib_none().0,
                hint.to_glib_none().0,
            )
        }
    ...
    fn invoke(&self, action_id: &str) {
        unsafe {
            ffi::astal_notifd_notification_invoke(
                self.as_ref().to_glib_none().0,
    ...
    #[doc(alias = "get_time")]
    fn time(&self) -> i64 {
        unsafe { ffi::astal_notifd_notification_get_time(self.as_ref().to_glib_none().0) }
    }
    ...
    fn app_name(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::astal_notifd_notification_get_app_name(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn app_icon(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::astal_notifd_notification_get_app_icon(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn summary(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::astal_notifd_notification_get_summary(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn body(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::astal_notifd_notification_get_body(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    #[doc(alias = "get_id")]
    fn id(&self) -> u32 {
        unsafe { ffi::astal_notifd_notification_get_id(self.as_ref().to_glib_none().0) }
    }

    #[doc(alias = "astal_notifd_notification_get_expire_timeout")]
    #[doc(alias = "get_expire_timeout")]
    fn expire_timeout(&self) -> i32 {
        unsafe { ffi::astal_notifd_notification_get_expire_timeout(self.as_ref().to_glib_none().0) }
    }
    ...
    fn actions(&self) -> Vec<Action> {
        unsafe {
            FromGlibPtrContainer::from_glib_none(ffi::astal_notifd_notification_get_actions(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn image(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::astal_notifd_notification_get_image(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn is_action_icons(&self) -> bool {
        unsafe {
            from_glib(ffi::astal_notifd_notification_get_action_icons(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn category(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::astal_notifd_notification_get_category(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn desktop_entry(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::astal_notifd_notification_get_desktop_entry(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn is_resident(&self) -> bool {
        unsafe {
            from_glib(ffi::astal_notifd_notification_get_resident(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn sound_file(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::astal_notifd_notification_get_sound_file(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn sound_name(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::astal_notifd_notification_get_sound_name(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn is_suppress_sound(&self) -> bool {
        unsafe {
            from_glib(ffi::astal_notifd_notification_get_suppress_sound(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn is_transient(&self) -> bool {
        unsafe {
            from_glib(ffi::astal_notifd_notification_get_transient(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    #[doc(alias = "get_x")]
    fn x(&self) -> i32 {
        unsafe { ffi::astal_notifd_notification_get_x(self.as_ref().to_glib_none().0) }
    }

    #[doc(alias = "astal_notifd_notification_get_y")]
    #[doc(alias = "get_y")]
    fn y(&self) -> i32 {
        unsafe { ffi::astal_notifd_notification_get_y(self.as_ref().to_glib_none().0) }
    }
    ...
    fn urgency(&self) -> Urgency {
        unsafe {
            from_glib(ffi::astal_notifd_notification_get_urgency(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn connect_resolved<F: Fn(&Self, ClosedReason) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn resolved_trampoline<
            P: IsA<Notification>,
            F: Fn(&P, ClosedReason) + 'static,
        >(
            this: *mut ffi::AstalNotifdNotification,
            reason: ffi::AstalNotifdClosedReason,
            f: glib::ffi::gpointer,
        ) {
            let f: &F = &*(f as *const F);
            f(
                Notification::from_glib_borrow(this).unsafe_cast_ref(),
                from_glib(reason),
            )
        }
        unsafe {
            ...
            connect_raw(
                ...
                b"resolved\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    resolved_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_invoked<F: Fn(&Self, &str) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn invoked_trampoline<P: IsA<Notification>, F: Fn(&P, &str) + 'static>(
            this: *mut ffi::AstalNotifdNotification,
            action_id: *const std::ffi::c_char,
            f: glib::ffi::gpointer,
        ) {
            let f: &F = &*(f as *const F);
            f(
                Notification::from_glib_borrow(this).unsafe_cast_ref(),
                &glib::GString::from_glib_borrow(action_id),
            )
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(
                self.as_ptr() as *mut _,
                b"invoked\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    invoked_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_time_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_time_trampoline<P: IsA<Notification>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalNotifdNotification,
    ...
    fn connect_app_icon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_app_icon_trampoline<
            P: IsA<Notification>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::AstalNotifdNotification,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::app-icon\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_app_icon_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_expire_timeout_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_expire_timeout_trampoline<
            P: IsA<Notification>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::AstalNotifdNotification,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::expire-timeout\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_expire_timeout_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_image_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_image_trampoline<P: IsA<Notification>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalNotifdNotification,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    fn connect_action_icons_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_action_icons_trampoline<
            P: IsA<Notification>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::AstalNotifdNotification,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::action-icons\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_action_icons_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_category_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_category_trampoline<
            P: IsA<Notification>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::AstalNotifdNotification,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::category\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_category_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_desktop_entry_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_desktop_entry_trampoline<
            P: IsA<Notification>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::AstalNotifdNotification,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::desktop-entry\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_desktop_entry_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_resident_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_resident_trampoline<
            P: IsA<Notification>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::AstalNotifdNotification,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::resident\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_resident_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_sound_file_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_sound_file_trampoline<
            P: IsA<Notification>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::AstalNotifdNotification,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::sound-file\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_sound_file_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_sound_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_sound_name_trampoline<
            P: IsA<Notification>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::AstalNotifdNotification,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::sound-name\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_sound_name_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_suppress_sound_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_suppress_sound_trampoline<
            P: IsA<Notification>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::AstalNotifdNotification,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::suppress-sound\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_suppress_sound_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_transient_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_transient_trampoline<
            P: IsA<Notification>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::AstalNotifdNotification,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::transient\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_transient_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_x_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_x_trampoline<P: IsA<Notification>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalNotifdNotification,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    fn connect_y_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_y_trampoline<P: IsA<Notification>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalNotifdNotification,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    fn connect_urgency_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_urgency_trampoline<
            P: IsA<Notification>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::AstalNotifdNotification,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::urgency\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_urgency_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
